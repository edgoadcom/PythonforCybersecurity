...
print("MD5       : {0}".format(crypt.crypt(plainPass,"$1$" + salt)))
print("Blowfish  : {0}".format(crypt.crypt(plainPass,"$2$" + salt)))
print("eksblofish: {0}".format(crypt.crypt(plainPass,"$2a$" + salt)))
print("SHA-256   : {0}".format(crypt.crypt(plainPass,"$5$" + salt)))
print("SHA-512   : {0}".format(crypt.crypt(plainPass,"$6$" + salt)))
